...
/**
 * Clase que representa la ruta 8 en el contexto de la fábrica de rutas.
 * Esta clase extiende la clase {@link FabricaRuta} y proporciona implementación
 * específica para la creación de las estaciones de la ruta 8.
 */
public class Ruta8 extends FabricaRuta {

    /**El nombre de la ruta. */
    private static final String NOMBRE = "Ruta 8";
    /**La coloración asociad a la ruta. */
    private static final ColorHex COLOR = ColorHex.RUTA8;
