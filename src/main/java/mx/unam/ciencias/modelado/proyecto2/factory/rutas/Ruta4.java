...
/**
 * Clase que representa la ruta 4 en el contexto de la fábrica de rutas.
 * Esta clase extiende la clase {@link FabricaRuta} y proporciona implementación
 * específica para la creación de las estaciones de la ruta 4.
 */
public class Ruta4 extends FabricaRuta {

    /**El nombre de la ruta. */
    private static final String NOMBRE = "Ruta 4";
    /**La coloración asociada a la ruta. */
    private static final ColorHex COLOR = ColorHex.RUTA4;
     ...
     */
    public Ruta4(List<String> lineas){
        super(lineas);
    }
