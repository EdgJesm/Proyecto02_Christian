...
import mx.unam.ciencias.modelado.proyecto2.edd.AccionVerticeGrafica;
import mx.unam.ciencias.modelado.proyecto2.edd.Grafica;
import mx.unam.ciencias.modelado.proyecto2.edd.GraficaDirigida;
import mx.unam.ciencias.modelado.proyecto2.edd.VerticeGrafica;
    ...
    @Test public void testConectaConPeso() {
        ...
        for (int i = 0; i < total; i++) {
            for (int j = i+1; j < total; j++) {
                ...
                Assert.assertTrue(grafica.getPesoApuntador(j, i) == peso);
            }
        }
        try {
